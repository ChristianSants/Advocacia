...
?>
      ...
      <br>
      <div class="container">
         <h1 class="page-header">Categoria Vara de Familia</h1>
            ...
            <table class="table table-striped table-bordered table-hover">
               ...
               <tbody>
                  <?php
                     ...
                     //foreach($user->listFiltroEspecialidade('Vara de familia') as $campo)
                     foreach($user->busca("SELECT * FROM advogados WHERE especialidade = 'Vara de familia' ORDER BY id ASC") as $campo)
                     {
